...
#COLS = ['std_sentence_count', 'spelling_correct', 'std_unique_words', 'std_total_words', 'essay_set',
...
for i in range(1, max_essay_set+1):
	...
	print "Linear (RIDGE) for Essay Set "+str(i)+":", Spearman(a = (valid_df[valid_df['essay_set'] == i])["std_score"], b = valid_pred_std_scores_ridge)
	print "\n"
	...
	print "Linear (LASSO) for Essay Set "+str(i)+":", Spearman(a = (valid_df[valid_df['essay_set'] == i])["std_score"], b = valid_pred_std_scores_lasso)
	print "\n"